...
function displayBooks(filteredBooks: Book[] = books) {
...
function editBook(index: number) {
    ...
    (document.getElementById('edit-publicationDate') as HTMLInputElement).value = book.publicationDate;
    (document.getElementById('edit-rating') as HTMLInputElement).value = book.rating.toString();
    openEditModal();
}
...
function saveChanges(event: Event) {
    ...
    const index = parseInt((document.getElementById('edit-index') as HTMLInputElement).value);
    ...
    const publicationDate = (document.getElementById('edit-publicationDate') as HTMLInputElement).value;
...
function updateInventorySummary() {
    ...
    const genresList = document.getElementById('genres-list') as HTMLUListElement;
    ...
    const authorsList = document.getElementById('authors-list') as HTMLUListElement;
...
function applyFilters() {
    const author = (document.getElementById('author') as HTMLInputElement).value.toLowerCase();
    const genre = (document.getElementById('genre') as HTMLInputElement).value.toLowerCase();
...
function clearInputFields() {
    ...
    (document.getElementById('modal-author') as HTMLInputElement).value = '';
    (document.getElementById('modal-genre') as HTMLInputElement).value = '';
    (document.getElementById('publicationDate') as HTMLInputElement).value = '';
    (document.getElementById('modal-rating') as HTMLInputElement).value = '';
}
...
function addBook(event: Event) {
    ...
    const author = (document.getElementById('modal-author') as HTMLInputElement).value;
    const genre = (document.getElementById('modal-genre') as HTMLInputElement).value;
    const publicationDate = (document.getElementById('publicationDate') as HTMLInputElement).value;
    const rating = parseInt((document.getElementById('modal-rating') as HTMLInputElement).value);
